...
programa
{
	...
	funcao inicio()
	{
		...
		distribuidorFinal = (precoFabrica - lucroDistribuidor)/63
		impostoFinal = (precoFabrica + imposto)/63

		precoFinal = precoFabrica + distribuidorFinal - impostoFinal

		escreva(" Lucro do distribuidor R$", distribuidorFinal)
		escreva("\nValor dos impostos R$ impostoFinal", impostoFinal)
		escreva("\nO preço final do Veículo R$precoFinal", precoFinal)
	}
}
/* $$$ Portugol Studio $$$ 
 * 
